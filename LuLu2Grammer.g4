...
ft_dcl: KEYWORD_DECLARE '{' ( func_dcl | type_dcl | var_def )+ '}';
...
type_def : KEYWORD_TYPE ID ( ':' ID )? '{' component+'}' ;
...
cond_stmt : KEYWORD_IF expr block ( KEYWORD_ELSE block )? | KEYWORD_SWITCH var '{' ( KEYWORD_CASE INT_CONST ':' block )* KEYWORD_DEFAULT ':' block '}';
